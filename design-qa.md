...
- Homepage TipHub announcement: passed. The paper-and-oxblood editorial chapter follows the existing product hero, keeps Toolclave as the primary brand, clearly labels the `$500K` figure as a TipHub-announced portfolio allocation, and preserves the existing botanical chapter rail.
